...
<BlogLayout  title="Introduction to 99 names modules" metaImage="https://salam.app/blog.png" metaData="Introduction to Salam App's 99 names modules and instructions to use it." link="https://salam.app/blog/99-names">
